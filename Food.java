...
public class Food {
     ...
     * @param name gets the name of the food the player comes in contact with from the FoodGenerator.
     * @param health gets the amount of health the food will increase the characters health by from the FoodGenerator.
     */
     ...
     * @return the health amount associated with the food the character comes in contact with.
     */
